...
namespace PTracking.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Message,CreatedDate,Viewed,Recipient")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Message,CreatedDate,Viewed,Recipient")] Notification notification)
        {
